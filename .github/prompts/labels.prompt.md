...
- a markdown file containing links to files
...
- Do not edit the file if it already has proper labels and fieldsets.

Keep a running checklist of which files you looked at and which ones you edited.
